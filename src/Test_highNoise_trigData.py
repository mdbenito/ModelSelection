...
hc.append(PolynomialHypothesis(M=2, variance=modelvariance))
hc.append(PolynomialHypothesis(M=3, variance=modelvariance))
hc.append(PolynomialHypothesis(M=4, variance=modelvariance))
hc.append(TrigonometricHypothesis(halfM=2, variance=modelvariance))
hc.append(TrigonometricHypothesis(halfM=10, variance=modelvariance))

obsNoiseSigma = 30 #try 0.2 for Polynomials
...
generate_noise_and_fit_iterative(lr, generator=TrigonometricHypothesis(halfM=2, variance=modelvariance, noiseVariance=obsNoiseSigma**2), xmin=0, xmax=6*math.pi, num=30)
input()
