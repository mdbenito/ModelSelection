...
hc.append(TrigonometricHypothesis(halfM=3, variance=modelvariance))
hc.append(TrigonometricHypothesis(halfM=6, variance=modelvariance))
...
generate_noise_and_fit_iterative(lr, generator=TrigonometricHypothesis(halfM=3, variance=modelvariance/4, noiseVariance=obsNoiseSigma**2), xmin=0, xmax=0.5*math.pi, num=60)
input()
